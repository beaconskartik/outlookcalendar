...
public class OutlookCalendarViewPager
        extends ViewPager
{
    public OutlookCalendarViewPager(Context context)
    {
        this(context, null);
    }
    
    public OutlookCalendarViewPager(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        init();
    }
    ...
    private void init()
    {
        mAdapter = new OutlookCalendarViewPagerAdapter(mDateChangeListener);
        setAdapter(mAdapter);
    ...
    private OutlookCalendarViewPagerAdapter mAdapter;
